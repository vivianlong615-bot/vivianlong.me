const sources: Resource[] = [
    ...
    },
    {
        ...
        type: 'texture',
        path: 'models/Computer/baked_computer.jpg?v=vivian-logo-22',
    },
    {
    ...
    },
    {
        ...
        type: 'texture',
        path: 'models/World/baked_environment.jpg?v=chair-white-1',
    },
    {
        name: 'decorModel',
        type: 'gltfModel',
    ...
    },
    {
        name: 'decorTexture',
        type: 'texture',
        path: 'models/Decor/baked_decor_modified.jpg?v=coffee-polka-3',
    },
    {
